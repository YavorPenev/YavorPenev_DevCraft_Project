                ...
                <div className='min-h-screen bg-gray-700 '>
                    <div className='flex flex-row items-center'>
                        ...
                        <div className='flex-row flex relative'>
                            <input
                                className="bg-gray-800 h-10 text-gray-200 pl-4 pr-10 py-2 rounded-lg border border-gray-700 focus:outline-none focus:ring-2 focus:ring-emerald-400 transition-all w-64"
                                type="text"
